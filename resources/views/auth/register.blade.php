...
<head>
    ...
    <script>
        ...
        function valide(){
           var val = document.forms['myform']['user_type'];
            if(val.value == "Faculty") {
                ...
                <div class="col-md-6 col-lg-5">
                    <div class="register-box bg-white box-shadow border-radius-10">
                        <div class="wizard-content">
                            <form  method="POST" id="myform" action="{{ route('register') }}" class="tab-wizard2 wizard-circle wizard" enctype="multipart/form-data" onsubmit=" return valide()">
                                @csrf
                                ...
                                <section>
                                    <div class="form-wrap max-width-600 mx-auto">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" id="phone" class="form-control @error('phone') is-invalid @enderror" name="phone" autocomplete="phone">
                                                @error('phone')
                                                <div class="alert alert-danger" role="alert"> {{ $message }}</div>
                                                @enderror
                                            </div>
                                ...
                                <section>
                                    <div class="form-wrap max-width-600 mx-auto">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control @error('street') is-invalid @enderror" name="street" value="{{ old('street') }}" autocomplete="street" autofocus>
                                                @error('street')
                                                <div class="alert alert-danger" role="alert"> {{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" class="form-control @error('city') is-invalid @enderror" name="city" value="{{ old('city') }}" autocomplete="city" autofocus>
                                                @error('city')
                                                <div class="alert alert-danger" role="alert"> {{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="country" id="country" class="form-control" title="Select country">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="user_type" id="type" class="form-control selectpicker" title="Select user Type" onchange="yesno(this);">
                                            ...
                                            <script type="text/javascript">
                                                function yesno(that){
                                                    if(that.value == "Admin"){
                                                        document.getElementById("ifad").style.visibility = "visible";
                                                    } else {
                                                        document.getElementById("ifad").style.visibility = "hidden";
                                                    }
                                                }
                                            </script>
                                        </div>
                                        <div class="form-group row" id="ifad" style="visibility: hidden;">
                                            <label class="col-sm-4 col-form-label">Secret Code</label>
                                            <div class="col-sm-8">
                                                <input type="text" id="code" class="form-control @error('code') is-invalid @enderror" name="code" autofocus placeholder="12345">
                                                <small class="text-danger">Do ask developer about the secret code</small>
                                            </div>
                                        </div>
                                ...
                                <section>
                                    <div class="form-wrap max-width-600 mx-auto">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">Date Of Birthday</label>
                                            <div class="col-sm-8">
                                                <input type="date" class="form-control @error('date_b') is-invalid @enderror" name="date_b" value="{{ old('date_b') }}" autocomplete="date_b" autofocus>
                                                @error('date_b')
                                                <div class="alert alert-danger" role="alert"> {{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="date" class="form-control @error('date_j') is-invalid @enderror" name="date_j" value="{{ old('date_j') }}" autocomplete="date_j" autofocus>
                                                @error('date_j')
                                                <div class="alert alert-danger" role="alert"> {{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select name="department_id" id="type" class="form-control selectpicker" title="Select department" >
