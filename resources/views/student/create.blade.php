        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form action="{{ route('student.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input id="regno" name="regno" class="form-control @error('regno') is-invalid @enderror" type="text" placeholder="MC191002" required>
                                @error('regno')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input id="name" name="name" class="form-control @error('name') is-invalid @enderror" type="text" placeholder="abdoul K" required>
                                @error('name')
                                <div class="alert alert-danger" role="alert"> {{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input id="tel" name="tel" class="form-control @error('tel') is-invalid @enderror" type="text" placeholder="8618....85" required>
                                @error('tel')
                                <div class="alert alert-danger" role="alert"> {{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <a href="{{ route('student.index') }}" class="btn btn-warning btn-block"> <i class="fa fa-arrow-left" aria-hidden="true"></i> Go to Students List</a>
                        </div>
                    </div>
